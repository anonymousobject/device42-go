...
type AdminUsersGroupsApiService service

/* 
AdminUsersGroupsApiService Get all Admin Groups
Get all Admin Groups
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return interface{}
*/
func (a *AdminUsersGroupsApiService) GetAdmingroups(ctx context.Context) (interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1.0/admingroups/"
...
/* 
AdminUsersGroupsApiService Get all Admin Users
Get Admin Users
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return interface{}
*/
func (a *AdminUsersGroupsApiService) GetAdminusers(ctx context.Context) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1.0/adminusers/"
...
/* 
AdminUsersGroupsApiService Create/Update Admin Users
Create/Edit Admin Users
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param username admin user name
 * @param password new user password
 * @param optional nil or *AdminUsersGroupsApiPostAdminUsersOpts - Optional Parameters:
     * @param "Groups" (optional.String) -  Admin groups to assign user to. Note: groups with commas need to be wrapped in quotes. ie: “System Generated Read, Add, Edit and Delete”

@return interface{}
*/

type AdminUsersGroupsApiPostAdminUsersOpts struct { 
	Groups optional.String
}

func (a *AdminUsersGroupsApiService) PostAdminUsers(ctx context.Context, username string, password string, localVarOptionals *AdminUsersGroupsApiPostAdminUsersOpts) (interface{}, *http.Response, error) {
	var (
