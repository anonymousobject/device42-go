...
type GetAllTagsApiService service

/* 
GetAllTagsApiService This will return a full list of tags available in your Device42 instance.
Get all Tags
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return interface{}
*/
func (a *GetAllTagsApiService) GetTags(ctx context.Context) (interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1.0/tags/"
