...
/* 
HistoryApiService Retrieves all history for the past one week. (Note, as of 10.3.0 Device42 now has a more robust audit log available at /api/api/1.0/auditlogs/
Get History
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return []GetHistory
*/
func (a *HistoryApiService) GetHistory(ctx context.Context) ([]GetHistory, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []GetHistory
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1.0/history/"
...
/* 
HistoryApiService Retrieves history for specified number of weeks in the past.
Get History by # of Weeks
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return []GetHistory
*/
func (a *HistoryApiService) GetHistoryNumberOfWeeks(ctx context.Context) ([]GetHistory, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1.0/history/<number_of_weeks>/"
