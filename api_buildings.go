...
/* 
BuildingsApiService Delete Building
...
@return interface{}
*/
func (a *BuildingsApiService) DeleteBuildings(ctx context.Context, iD int32) (interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1.0/buildings/{ID}/"
...
/* 
BuildingsApiService Retrieve information about all buildings.
Get All Buildings
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BuildingsApiGetBuildingsOpts - Optional Parameters:
     * @param "Name" (optional.String) -  filter by name (Added in v6.0.0)

@return interface{}
*/

type BuildingsApiGetBuildingsOpts struct { 
	Name optional.String
}

func (a *BuildingsApiService) GetBuildings(ctx context.Context, localVarOptionals *BuildingsApiGetBuildingsOpts) (interface{}, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1.0/buildings/"
...
/* 
BuildingsApiService Create/update buildings.
Create/Update Building
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Name of building
 * @param address Address of building.
 * @param optional nil or *BuildingsApiPostBuildingsOpts - Optional Parameters:
...
type BuildingsApiPostBuildingsOpts struct { 
...
func (a *BuildingsApiService) PostBuildings(ctx context.Context, name string, address string, localVarOptionals *BuildingsApiPostBuildingsOpts) (interface{}, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.ContactName.IsSet() {
		localVarFormParams.Add("contact_name", parameterToString(localVarOptionals.ContactName.Value(), ""))
	}
...
/* 
BuildingsApiService Create/update custom fields for buildings.
 ...
 * @param optional nil or *BuildingsApiPutCustomFieldsBuildingOpts - Optional Parameters:
     * @param "Name" (optional.String) -  Name of building
     * @param "Id" (optional.String) -  ID of building
...
type BuildingsApiPutCustomFieldsBuildingOpts struct { 
	Name optional.String
	Id optional.String
...
func (a *BuildingsApiService) PutCustomFieldsBuilding(ctx context.Context, key string, localVarOptionals *BuildingsApiPutCustomFieldsBuildingOpts) (interface{}, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1.0/custom_fields/building/"
