...
/* 
VendorsApiService Delete Vendor
...
@return interface{}
*/
func (a *VendorsApiService) DeleteVendors(ctx context.Context, id int32) (interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1.0/vendors/{id}/"
...
/* 
VendorsApiService Get all Vendors
Get all Vendors
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return interface{}
*/
func (a *VendorsApiService) GetVendors(ctx context.Context) (interface{}, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1.0/vendors/"
 ...
 * @param optional nil or *VendorsApiPostVendorsOpts - Optional Parameters:
     * @param "AccountNo" (optional.String) - 
     * @param "HomePage" (optional.String) -  Text field.
     * @param "ContactInfo" (optional.String) - 
     * @param "Escalation1" (optional.String) -  Text field.
     * @param "Escalation2" (optional.String) -  Text field.
...
type VendorsApiPostVendorsOpts struct { 
	AccountNo optional.String
	HomePage optional.String
	ContactInfo optional.String
	Escalation1 optional.String
	Escalation2 optional.String
	Notes optional.String
	Groups optional.String
}

func (a *VendorsApiService) PostVendors(ctx context.Context, name string, localVarOptionals *VendorsApiPostVendorsOpts) (interface{}, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.AccountNo.IsSet() {
		localVarFormParams.Add("account_no", parameterToString(localVarOptionals.AccountNo.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.HomePage.IsSet() {
		localVarFormParams.Add("home_page", parameterToString(localVarOptionals.HomePage.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.Escalation1.IsSet() {
		localVarFormParams.Add("escalation_1", parameterToString(localVarOptionals.Escalation1.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Escalation2.IsSet() {
		localVarFormParams.Add("escalation_2", parameterToString(localVarOptionals.Escalation2.Value(), ""))
	}
