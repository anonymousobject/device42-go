...
type ObjectCategoriesApiService service

/* 
ObjectCategoriesApiService This call will get information about object categories.
Get all Object Categories
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ObjectCategoriesApiGetObjectCategoriesOpts - Optional Parameters:
     * @param "Name" (optional.String) -  filter by name (Added in v6.0.0)

@return interface{}
*/

type ObjectCategoriesApiGetObjectCategoriesOpts struct { 
	Name optional.String
}

func (a *ObjectCategoriesApiService) GetObjectCategories(ctx context.Context, localVarOptionals *ObjectCategoriesApiGetObjectCategoriesOpts) (interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1.0/object_categories/"
...
/* 
ObjectCategoriesApiService This call will create/update information about object categories.
Create/update Object Categories
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Name of object category to create/update
 * @param optional nil or *ObjectCategoriesApiPostObjectCategoriesOpts - Optional Parameters:
     * @param "Description" (optional.String) -  Description of object category

@return interface{}
*/

type ObjectCategoriesApiPostObjectCategoriesOpts struct { 
	Description optional.String
}

func (a *ObjectCategoriesApiService) PostObjectCategories(ctx context.Context, name string, localVarOptionals *ObjectCategoriesApiPostObjectCategoriesOpts) (interface{}, *http.Response, error) {
	var (
