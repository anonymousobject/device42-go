...
/* 
ServiceLevelsApiService Get all Service Levels (devices)
Get all Service Levels
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return []InlineResponse20011
*/
func (a *ServiceLevelsApiService) GetServiceLevel(ctx context.Context) ([]InlineResponse20011, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1.0/service_level/"
...
/* 
ServiceLevelsApiService Create Service Level.
Create Service Level
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Name of the Service Level

@return interface{}
*/
func (a *ServiceLevelsApiService) PostServiceLevel(ctx context.Context, name string) (interface{}, *http.Response, error) {
	var (
