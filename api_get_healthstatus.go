...
type GetHealthstatusApiService service

/* 
GetHealthstatusApiService This will return the health status of Device42 including the status of recent backups.
Get Healthstatus
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return BackupStatus
*/
func (a *GetHealthstatusApiService) GetHealthstats(ctx context.Context) (BackupStatus, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + ":4343/healthstats/"
