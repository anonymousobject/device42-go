...
type SetStandbyOrProductionModeApiService service

/* 
SetStandbyOrProductionModeApiService Set Standby or Production Mode
...
@return interface{}
*/
func (a *SetStandbyOrProductionModeApiService) PostAppliancemode(ctx context.Context, applianceMode string) (interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + ":4343/api/1.0/appliancemode/"
	...
	localVarFormParams.Add("appliance_mode", parameterToString(applianceMode, ""))
