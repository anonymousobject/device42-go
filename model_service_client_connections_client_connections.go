...
type ServiceClientConnectionsClientConnections struct {
	ListenerDeviceId int32 `json:"listener_device_id,omitempty"`
	ClientServiceId int32 `json:"client_service_id,omitempty"`
	Stats *interface{} `json:"stats,omitempty"`
	ClientDeviceId int32 `json:"client_device_id,omitempty"`
	...
	ListenerMappedServiceId int32 `json:"listener_mapped_service_id,omitempty"`
	...
	ListenerDiscoveredServiceId int32 `json:"listener_discovered_service_id,omitempty"`
	ServicePortIpId int32 `json:"service_port_ip_id,omitempty"`
}
