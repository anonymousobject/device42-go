...
type DeviceNameProfileApiService service

/* 
DeviceNameProfileApiService This call creates or updates a device name profile.
Create/update device name profile
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Used to easily identify different profiles for generating device names.
 * @param numberLength Number length between 2 and 7. For numbers up to 9999, it would be 4. Default is 4.
 * @param startNumber Starting number, where you want device numbers to start from. Default is 1.
 * @param lastUsed DO NOT CHANGE, unless you know what it is used for :). Default is 0.
 * @param optional nil or *DeviceNameProfileApiApi10DeviceNameProfilePostOpts - Optional Parameters:
     * @param "Prefix" (optional.String) -  Prefix for the generated name number; e.g., SecretDC-Server in SecretDC-Server0042.
     * @param "Suffix" (optional.String) -  Suffix for the generated name number; e.g., .domain.pvt in SecretDC-Server0042.domain.pvt.

@return interface{}
*/

type DeviceNameProfileApiApi10DeviceNameProfilePostOpts struct { 
	Prefix optional.String
	Suffix optional.String
}

func (a *DeviceNameProfileApiService) Api10DeviceNameProfilePost(ctx context.Context, name string, numberLength int32, startNumber int32, lastUsed int32, localVarOptionals *DeviceNameProfileApiApi10DeviceNameProfilePostOpts) (interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1.0/device_name_profile/"
	...
	localVarFormParams.Add("number_length", parameterToString(numberLength, ""))
	localVarFormParams.Add("start_number", parameterToString(startNumber, ""))
	localVarFormParams.Add("last_used", parameterToString(lastUsed, ""))
	if localVarOptionals != nil && localVarOptionals.Prefix.IsSet() {
		localVarFormParams.Add("prefix", parameterToString(localVarOptionals.Prefix.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Suffix.IsSet() {
		localVarFormParams.Add("suffix", parameterToString(localVarOptionals.Suffix.Value(), ""))
	}
...
/* 
DeviceNameProfileApiService This call deletes a device name profile.
This API is used to delete a device name profile with the device name profile id supplied as the required argument.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id device name profile id

@return interface{}
*/
func (a *DeviceNameProfileApiService) DeletedeviceProfileNames(ctx context.Context, id int32) (interface{}, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1.0/device_name_profile/{id}/"
...
/* 
DeviceNameProfileApiService This call will get all device name profiles.
Get all device name profiles.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *DeviceNameProfileApiGetdeviceNameProfileOpts - Optional Parameters:
     * @param "Name" (optional.String) -  Used to easily identify different profiles for generating device names.

@return interface{}
*/

type DeviceNameProfileApiGetdeviceNameProfileOpts struct { 
	Name optional.String
}

func (a *DeviceNameProfileApiService) GetdeviceNameProfile(ctx context.Context, localVarOptionals *DeviceNameProfileApiGetdeviceNameProfileOpts) (interface{}, *http.Response, error) {
	var (
