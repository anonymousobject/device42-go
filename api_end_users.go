...
/* 
EndUsersApiService Delete End User
...
@return interface{}
*/
func (a *EndUsersApiService) DeleteEndUsers(ctx context.Context, id int32) (interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1.0/endusers/{id}/"
...
/* 
EndUsersApiService Get all End Users
Get End Users
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return interface{}
*/
func (a *EndUsersApiService) GetEndusers(ctx context.Context) (interface{}, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1.0/endusers/"
...
/* 
EndUsersApiService Create / Update End Users
Create / Update End Users
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name enduser name
 * @param optional nil or *EndUsersApiPostEndUsersOpts - Optional Parameters:
...
type EndUsersApiPostEndUsersOpts struct { 
...
func (a *EndUsersApiService) PostEndUsers(ctx context.Context, name string, localVarOptionals *EndUsersApiPostEndUsersOpts) (interface{}, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.Contact.IsSet() {
		localVarFormParams.Add("contact", parameterToString(localVarOptionals.Contact.Value(), ""))
	}
