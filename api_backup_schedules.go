...
type BackupSchedulesApiService service

/* 
BackupSchedulesApiService Get Backup Schedules
Get Backup Schedules
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return interface{}
*/
func (a *BackupSchedulesApiService) GetBackupSchedules(ctx context.Context) (interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + ":4343/api/1.0/backup_schedules/"
...
/* 
BackupSchedulesApiService Set Backup Schedules via API
This will create a scheduled backup nightly at 11:00 PM, using the NFS server settings.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name name of backup job
 * @param method Backup method: 1 for mail,2 for sftp,3 for nfs or 4 for amazon s3
 * @param scheduleTime time to perform backup (0:00 to 23:59)
 * @param optional nil or *BackupSchedulesApiPostBackupSchedulesOpts - Optional Parameters:
...
type BackupSchedulesApiPostBackupSchedulesOpts struct { 
	ScheduleDays optional.String
}

func (a *BackupSchedulesApiService) PostBackupSchedules(ctx context.Context, name string, method string, scheduleTime string, localVarOptionals *BackupSchedulesApiPostBackupSchedulesOpts) (interface{}, *http.Response, error) {
	var (
	...
	localVarFormParams.Add("method", parameterToString(method, ""))
	localVarFormParams.Add("schedule_time", parameterToString(scheduleTime, ""))
