...
/* 
AuditLogApiService Retrieves the audit history for all changes made in Device42.
Get Audit Logs
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AuditLogApiGetAuditlogsOpts - Optional Parameters:
     * @param "ObjectId" (optional.String) -  Filters by object ID (ie, device ID, asset ID)
     * @param "ContentType" (optional.String) -  Returns changes done to a particular content type
     * @param "ActionTimeGt" (optional.String) -  Filters actions that have happened past the time entered (ie, greater than 2 weeks) in YYYY-MM-DDTHH:MM:ss.uuuuuu (ie 2016-10-27T13:52:01.213416)
     * @param "ActionTimeLt" (optional.String) -  Returns actions within the last X amount of days in YYYY-MM-DDTHH:MM:ss.uuuuuu (ie 2016-10-27T13:52:01.213416)

@return GetAuditLogs
*/

type AuditLogApiGetAuditlogsOpts struct { 
	ObjectId optional.String
	ContentType optional.String
	ActionTimeGt optional.String
	ActionTimeLt optional.String
}

func (a *AuditLogApiService) GetAuditlogs(ctx context.Context, localVarOptionals *AuditLogApiGetAuditlogsOpts) (GetAuditLogs, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue GetAuditLogs
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1.0/auditlogs/"
	...
	if localVarOptionals != nil && localVarOptionals.ActionTimeGt.IsSet() {
		localVarQueryParams.Add("action_time_gt", parameterToString(localVarOptionals.ActionTimeGt.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.ActionTimeLt.IsSet() {
