...
type PowerCircuitsApiService service

/* 
PowerCircuitsApiService Power Circuit
This API is used to delete the power circuit with the ID supplied as the required argument.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Power circuit ID

@return interface{}
*/
func (a *PowerCircuitsApiService) DeletePowerCircuit(ctx context.Context, id int32) (interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1.0/powercircuits/{id}/"
...
/* 
PowerCircuitsApiService Get All Power Circuits
Get All Power Circuits
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PowerCircuitsApiGetAllPowerCircuitsOpts - Optional Parameters:
     * @param "BreakerpanelId" (optional.String) -  Breaker panel ID
     * @param "BcpmId" (optional.String) -  Branch Circuit Power Meter ID

@return interface{}
*/

type PowerCircuitsApiGetAllPowerCircuitsOpts struct { 
	BreakerpanelId optional.String
	BcpmId optional.String
}

func (a *PowerCircuitsApiService) GetAllPowerCircuits(ctx context.Context, localVarOptionals *PowerCircuitsApiGetAllPowerCircuitsOpts) (interface{}, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/1.0/powercircuits/"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if localVarOptionals != nil && localVarOptionals.BreakerpanelId.IsSet() {
		localVarQueryParams.Add("breakerpanel_id", parameterToString(localVarOptionals.BreakerpanelId.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.BcpmId.IsSet() {
		localVarQueryParams.Add("bcpm_id", parameterToString(localVarOptionals.BcpmId.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{"application/x-www-form-urlencoded"}
...
/* 
PowerCircuitsApiService Create/Update Power Circuit
Create/Update Power Circuit
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param breakerpanelId Breaker panel ID
 * @param number Number of the circuit on the breaker panel
 * @param optional nil or *PowerCircuitsApiPostUpdatePowerCircuitsOpts - Optional Parameters:
     * @param "Label" (optional.String) -  Label of the circuit on the breaker panel
     * @param "Connection" (optional.String) -  Description of the connection for the circuit
     * @param "Voltage" (optional.String) -  The rated voltage on this circuit
     * @param "Amps" (optional.String) -  The rated amps on this circuit
     * @param "PowerunitConnectionIds" (optional.String) -  A comma-separated list of PU IDs connected to this circuit
     * @param "DeviceConnectionIds" (optional.String) -  A comma-separated list of device IDs connected to this circuit
     * @param "DeviceConnectionNames" (optional.String) -  A comma-separated list of device names connected to this circuit
     * @param "AssetConnectionIds" (optional.String) -  A comma-separated list of asset IDs connected to this circuit

@return interface{}
*/

type PowerCircuitsApiPostUpdatePowerCircuitsOpts struct { 
	Label optional.String
	Connection optional.String
	Voltage optional.String
	Amps optional.String
	PowerunitConnectionIds optional.String
	DeviceConnectionIds optional.String
	DeviceConnectionNames optional.String
	AssetConnectionIds optional.String
}

func (a *PowerCircuitsApiService) PostUpdatePowerCircuits(ctx context.Context, breakerpanelId string, number string, localVarOptionals *PowerCircuitsApiPostUpdatePowerCircuitsOpts) (interface{}, *http.Response, error) {
	var (
	...
	localVarFormParams.Add("breakerpanel_id", parameterToString(breakerpanelId, ""))
	...
	if localVarOptionals != nil && localVarOptionals.Connection.IsSet() {
		localVarFormParams.Add("connection", parameterToString(localVarOptionals.Connection.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Voltage.IsSet() {
		localVarFormParams.Add("voltage", parameterToString(localVarOptionals.Voltage.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Amps.IsSet() {
		localVarFormParams.Add("amps", parameterToString(localVarOptionals.Amps.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.PowerunitConnectionIds.IsSet() {
		localVarFormParams.Add("powerunit_connection_ids", parameterToString(localVarOptionals.PowerunitConnectionIds.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.DeviceConnectionIds.IsSet() {
		localVarFormParams.Add("device_connection_ids", parameterToString(localVarOptionals.DeviceConnectionIds.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.DeviceConnectionNames.IsSet() {
		localVarFormParams.Add("device_connection_names", parameterToString(localVarOptionals.DeviceConnectionNames.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.AssetConnectionIds.IsSet() {
		localVarFormParams.Add("asset_connection_ids", parameterToString(localVarOptionals.AssetConnectionIds.Value(), ""))
	}
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
