 ...
 * @param optional nil or *ReportsApiGetReportsOpts - Optional Parameters:
     * @param "CsvFormat" (optional.String) -  If this parameter is ‘xls’ or is not present, an Excel file(.xlsx) will be produced. If this parameter is ‘tab’, a tab-delimited file(.txt) will be created.

@return interface{}
*/

type ReportsApiGetReportsOpts struct { 
	CsvFormat optional.String
}

func (a *ReportsApiService) GetReports(ctx context.Context, id int32, localVarOptionals *ReportsApiGetReportsOpts) (interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/1.0/reports/{id}/"
	...
	if localVarOptionals != nil && localVarOptionals.CsvFormat.IsSet() {
